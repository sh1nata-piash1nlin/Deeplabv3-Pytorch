...
#         ToTensorV2()
#     ])
#     valid_transform = A.Resize(args.image_size, args.image_size),
#     train_data = VOCDataset(root=args.dataPath, year=args.year, image_set="train", download=False,
#                             augmentations=albumentations_transform)
#     valid_data = VOCDataset(root=args.dataPath, year=args.year, image_set="val", download=False,
